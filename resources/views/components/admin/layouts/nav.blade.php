<nav class="main-header navbar navbar-expand navbar-white border-bottom bg-white">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link p-1" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown ">
            <a class="nav-link py-0" data-toggle="dropdown" href="#" aria-expanded="false">
                <img src="{{ $adminUser->profile_src }}" id="image" style="width:35px;"
            ...
            <div class="dropdown-menu dropdown-menu-right mt-2">
                ...
                <a href="{{ route('admin.logout') }}" class="dropdown-item text-gray">
                    <i class="fa fa-power-off f-18 pr-1"></i> Sign Out
                </a>
            </div>
        </li>
    </ul>
