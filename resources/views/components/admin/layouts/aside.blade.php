  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
        ...
        @if ($adminUser->can('sub-categories'))
        <li class="nav-item ">
        ...
        @if ($adminUser->can('log-viewer'))
        @if (config('log-viewer.show'))
          <li class="nav-item has-treeview {{  Helper::isActive(['log-viewer::dashboard', 'log-viewer::logs.list'], 'menu-open') }}">
