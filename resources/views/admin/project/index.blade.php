                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.projects.index') }}">Project</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <!-- Default box -->
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Project Datatable</h3>
                        <a href="javascript:void(0)" class="btn btn-primary float-right" id="createproject">Create Project</a>
                                    ...
                                    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group select2-primary">
                                                ...
                                                data-placeholder="Write some Tag"  data-dropdown-css-class="select2-primary" multiple="multiple">
                                                </select>
                                            </div>
                                        </div>
                                        @csrf
