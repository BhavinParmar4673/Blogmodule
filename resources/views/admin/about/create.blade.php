...
@section('content')
    <div class="content-wrapper">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.about-us.create') }}">New
                                            About Us</a></li>
                                </ol>
                            </div>
                        </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="col-sm-12 col-md-7">
                    <form action="{{ route('admin.about-us.store') }}" method="POST" id="form-data">
                        @csrf
                        <x-card>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="heading" id="heading" value="{{ old('heading') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label fs-6 fw-bolder mb-3">Video URl <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="file" id="file" value="{{ old('file') }}" required
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="content" id="content" rows="6">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </x-card>
