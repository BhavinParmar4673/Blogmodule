            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.testimonials.create') }}" class="btn btn-primary float-right">Add New
                            Testimonial</a>
                        <a href="javascript:void(0)" id="index" data-url="{{ route('admin.testimonials.list') }}"></a>
                    </div>
                    <div class="card-body">
                        @if (session('message'))
