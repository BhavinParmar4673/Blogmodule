                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.service.edit', $service->id) }}">Edit
                                            Testimonial</a></li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            data-rule-remote="{{ route('admin.service.exists', ['id' => $service->id]) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="slug" required id="slug"
                                            class="form-control form-control-solid" value="{{ $service->slug ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" rows="3" required
                                            class="form-control form-control-solid">{{ $service->description ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="d-flex flex-column">
                                        ...
                                        <img src="{{ $service->image_src ?? '' }}" alt="preview image"
                                            style="width:120px;">
                                    </div>
                                </div>
                            </div>
