      ...
      <div class="container-fluid">
          <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.sliders.create') }}" class="btn btn-primary float-right">Add New Slider</a>
                <a href="javascript:void(0)" id="index" data-url="{{ route('admin.allslider') }}"></a>
            </div>
            <div class="card-body">
                @if (session('message'))
