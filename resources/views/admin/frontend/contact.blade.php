                                        ...
                                        <div class="row">
                                            <div class="col-md-12 my-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-border" name="name" value="{{ old('name') }}" id="name"
                                                    placeholder="Name">
                                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-md-12 my-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-border" name="email" value="{{ old('email') }}" id="email"
                                                    placeholder="Email">
                                                    @if ($errors->has('email'))
                                            ...
                                            <div class="col-md-12 my-3">
                                                <div class="form-group">
                                                    <textarea class="form-control form-control-border" id="message" placeholder="Message" name="message" rows="3">{{ old('message') }}</textarea>
